...
//
//        //Analyzer analyzer = new ChineseWordAnalyzer(SegmentationAlgorithm.MaximumMatching);
//
//        TokenStream tokenStream = null;
//        try {
//            tokenStream = analyzer.tokenStream("text", "���д���APDPlatӦ�ü���Ʒ����ƽ̨������");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//
...
public static void main(String[] args) throws IOException {
    ...
    Analyzer analyzer = new word.MyWordAnalyzer();
    ...
    while(tokenStream.incrementToken()){
        ...
        System.out.print(teAttribute.toString() + "|");
        if (teAttribute.toString().length()>=2){
            outputStream.write(teAttribute.toString().getBytes());
