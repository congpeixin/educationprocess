...
import cn.datapark.process.education.SimHash.{ArticleExtractTopoConfig, ConfigUtil}
...
/**
  * Created by cluster on 2017/8/8.
  *
  *
  *
  */
object streamingProcessnoetlToDB extends Serializable {
  Logger.getLogger("org").setLevel(Level.ERROR)
  Logger.getLogger("org.apache.kafka").setLevel(Level.ERROR)
  Logger.getLogger("org.apache.zookeeper").setLevel(Level.ERROR)
  Logger.getLogger("org.apache.spark").setLevel(Level.ERROR)
//  ConfigUtil.initConfig(streamingProcessToDB.getClass.getClassLoader.getResourceAsStream(ConfigUtil.topoConfigfile))
//  val topoConfig: ArticleExtractTopoConfig = ConfigUtil.getConfigInstance
  def main(args: Array[String]) {
    ...
    val sql_commerce: String = "INSERT INTO commerce_noETL (site_name,post_title,post_url,content_text,content_html,crawl_time,type,module,keywords,state) VALUES (?,?,?,?,?,?,?,?,?,?)"
